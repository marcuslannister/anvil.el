...
** Stable (recommended) — tag =v0.2.1=

=v0.2.1= is the current stable tag.  New features and fixes
...
;; with elpaca
(use-package anvil
  :ensure (:host github :repo "zawatton/anvil.el" :ref "v0.2.1"))
#+end_src
...
When cloning manually, check out the =v0.2.1= tag for the stable
track (=git checkout v0.2.1=), or stay on =master= at your own
risk.

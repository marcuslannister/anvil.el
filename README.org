...
Rust runtime called NeLisp) as ~170 tools an AI agent can call.
...
| Repo | Role | Required? |
|------+------+-----------|
| [[https://github.com/zawatton/anvil.el][anvil.el]]      | The AI brain — MCP server + ~150 tools | yes |
...
Anvil exposes *~170 MCP tools* across the v1.0.0 surface
...
Anvil exposes ~150 named primitives, each registered with an explicit

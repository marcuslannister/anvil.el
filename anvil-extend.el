;;; anvil-extend.el --- Claude self-extension SDK scaffold + hot-reload + rationale (Phase A+B+D) -*- lexical-binding: t; -*-
...
;; anvil-extend implements Phases A, B and D of the Claude self-extension
...
;;
;; Phases C, E, F (sandbox eval / NeLisp execute path / ephemeral-
;; permanent promotion gates) remain out of scope per Doc 38 §3.C, E, F.

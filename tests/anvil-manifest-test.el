...
plus the real `manifest-cost' handler, then cleans up."
  (declare (indent 0))
...
(defun anvil-manifest-test--tools-list-names ()
  ...
  (let ((response-json nil))
    (cl-letf (((symbol-function 'anvil-server--jsonrpc-response)
      ...
      (anvil-server--handle-tools-list 1 "default"))
